...
run_quality_checks = DataQualityOperator(
    ...
    dag=dag,
    redshift_conn_id='redshift_id',
    tables=["transactions", "block", "block_transaction"]
)
...
[stage_blocks_to_redshift, stage_transaction_to_redshift] >> load_block_transaction_table

load_block_transaction_table >> load_transaction_dimension_table
load_block_transaction_table >> load_block_dimension_table

load_transaction_dimension_table >> run_quality_checks
load_block_dimension_table >> run_quality_checks
